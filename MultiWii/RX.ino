...
void readNrf24()
{
  ...
  rcValue[rcChannel[0]] = data[0];
  rcValue[rcChannel[1]] = data[1];
  rcValue[rcChannel[2]] = data[2];
  rcValue[rcChannel[3]] = data[3];
  rcValue[rcChannel[4]] = data[4];
}
